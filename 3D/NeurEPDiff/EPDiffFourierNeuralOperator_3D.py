...
if __name__ == "__main__":
    ...
    # print(f"Memoria reservada: {reserved_memory / (1024**3):.2f} GB")
    ...
    if GAUSSNORM:
        torch.save(model, 'OASIS_FNO3D_GaussNorm_model_A.pt')
    elif NORM_1_1:
        torch.save(model, 'OASIS_FNO3D_1_1_model_A.pt')
    elif NORM_0_1:
        torch.save(model, 'OASIS_FNO3D_0_1_model_A.pt')
    else:
        torch.save(model, 'OASIS_FNO3D_model_A.pt' )
